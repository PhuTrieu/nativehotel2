...
export default class FromCustomer extends Component {
    ...
    findCustomerByID(idCustomer){
        axios.get('http://nativehotel2.herokuapp.com/api/customer/'+idCustomer).then( response => {
            if(response!=null){
                this.setState({
    ...
    saveChange(){
        ...
        if(window.confirm('Are you sure?')){
            ...
            axios.put('http://nativehotel2.herokuapp.com/api/customer/'+customer.idKH,customer).then(response => {
