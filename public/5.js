...
var BookingInfo = /*#__PURE__*/function (_Component) {
  ...
  _createClass(BookingInfo, [{
    ...
    value: function componentWillMount() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('http://nativehotel2.herokuapp.com/api/room_types/' + idPhongDat).then(function (res) {
        if (res.data != null) {
          _this2.setState({
            ...
            axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('https://nativehotel2.herokuapp.com/api/room_types/' + id).then(function (res) {
              if (res.data != null) {
                _this3.setState({
                  ...
                  axios__WEBPACK_IMPORTED_MODULE_2___default.a.put('http://nativehotel2.herokuapp.com/api/room_types/' + room.idLP, room).then(function (res) {
                    if (res.data != null) {
                      var customer = {
