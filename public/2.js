...
var Register = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Register, [{
    ...
    value: function loadCustomers() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://nativehotel2.herokuapp.com/api/customer').then(function (response) {
        _this2.setState({
    ...
    value: function deleteCustomer(id) {
      ...
      if (window.confirm('Are you sure?')) {
        axios__WEBPACK_IMPORTED_MODULE_3___default.a["delete"]('http://nativehotel2.herokuapp.com/api/customer/' + id).then(function (response) {
