...
var RateRecord = /*#__PURE__*/function (_Component) {
  ...
  _createClass(RateRecord, [{
    ...
    value: function componentWillMount() {
      ...
      axios.get('http://nativehotel2.herokuapp.com/api/room_type_rate/' + this.props.idLP).then(function (response) {
...
var Rates = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Rates, [{
    ...
    value: function loadRoomTypes() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('http://nativehotel2.herokuapp.com/api/room_types').then(function (response) {
        _this2.setState({
