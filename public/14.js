...
var AdminAccountForm = /*#__PURE__*/function (_Component) {
  ...
  _createClass(AdminAccountForm, [{
    ...
    value: function findAdminAccountByID(idAdminAcc) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('http://nativehotel2.herokuapp.com/api/admin_accounts/' + idAdminAcc).then(function (res) {
        if (res.data != null) {
          _this2.setState({
    ...
    value: function saveChange(e) {
      ...
      if (window.confirm('Are you sure ?')) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_5___default.a.put('http://nativehotel2.herokuapp.com/api/admin_accounts/' + AdminAccount.idAdmin, AdminAccount).then(function (res) {
          if (res.data != null) {
            setTimeout(function () {
