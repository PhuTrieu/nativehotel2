...
var RoomTypes = /*#__PURE__*/function (_Component) {
  ...
  _createClass(RoomTypes, [{
    ...
    value: function loadRoomTypes() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://nativehotel2.herokuapp.com/api/room_types').then(function (response) {
        _this2.setState({
    ...
    value: function deleteRoomType(obj) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('http://nativehotel2.herokuapp.com/api/room_types_delete_file', data).then(function (res) {
          if (res.data) console.log('Đã xóa hình cũ');else console.log('Không có hình cũ');
        });
        axios__WEBPACK_IMPORTED_MODULE_3___default.a["delete"]('http://nativehotel2.herokuapp.com/api/room_types/' + obj.id).then(function (res) {
          if (res.data != null) {
