...
var AddRoomType = /*#__PURE__*/function (_Component) {
  ...
  _createClass(AddRoomType, [{
    ...
    value: function submitRoomType(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_6___default.a.post('http://nativehotel2.herokuapp.com/api/room_types_upload_file', fd, {
        headers: {
          "Content-Type": "multipart/form-data"
        }
      }).then(function (res) {
        ...
        _this2.setState({
          ...
          axios__WEBPACK_IMPORTED_MODULE_6___default.a.post('http://nativehotel2.herokuapp.com/api/room_types', roomType).then(function (res) {
            if (res.data != null) {
              _this2.resetForm();
