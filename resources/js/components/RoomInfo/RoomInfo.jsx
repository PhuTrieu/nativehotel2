...
import { FaBath, FaHotel, FaRegHandshake, FaWindowRestore } from "react-icons/fa";
...
export default class RoomInfo extends Component {
    ...
    findRoomRateByID(id){
        ...
        axios.get('http://nativehotel2.herokuapp.com/api/room_type_rate/' + id).then(res =>{
            this.setState({
    ...
    showImages(){
        ...
        var lst = this.state.hinhAnh.map((item, index)=>
            <div  style={{ height: '43vh', width: '43vh', overflow: 'hidden' }}>
                <img 
