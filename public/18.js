...
var FromRates = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FromRates, [{
    ...
    value: function findRatesByID(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get('http://nativehotel2.herokuapp.com/api/rates/' + id).then(function (response) {
        if (response != null) {
          _this2.setState({
    ...
    value: function loadRoomTypes() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get('http://nativehotel2.herokuapp.com/api/room_types').then(function (response) {
    ...
    value: function saveChange() {
      ...
      if (window.confirm('Are you sure?')) {
        console.log(rates);
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.put('http://nativehotel2.herokuapp.com/api/rates/' + rates.idBG, rates).then(function (response) {
          if (response.data != null) {
