...
var AddRates = /*#__PURE__*/function (_Component) {
  ...
  _createClass(AddRates, [{
    ...
    value: function loadRoomTypes() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_10___default.a.get('http://nativehotel2.herokuapp.com/api/room_types').then(function (response) {
    ...
    value: function saveChange(e) {
      ...
      if (window.confirm('Are you sure?')) {
        axios__WEBPACK_IMPORTED_MODULE_10___default.a.post('http://nativehotel2.herokuapp.com/api/rates', rates).then(function (response) {
          if (response.data != null) {
            _this3.resetForm();
