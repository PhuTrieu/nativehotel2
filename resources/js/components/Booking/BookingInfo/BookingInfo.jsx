...
export default class BookingInfo extends Component {
    ...
    componentWillMount(){
        ...
        axios.get('http://nativehotel2.herokuapp.com/api/room_types/' + idPhongDat).then(res => {
            if (res.data != null) {
                this.setState({
    ...
    submitBookNow(e){
        ...
        this.setState({errors},
            ()=>{
                ...
                axios.post('http://nativehotel2.herokuapp.com/api/exist_mail', checkEmail).then(res =>{
                    if (res.data) {
                        var id = JSON.parse(localStorage.getItem('itemsShoppingCart'))[0].idLP;
                        axios.get('https://nativehotel2.herokuapp.com/api/room_types/' + id).then( res => {
                            if (res.data != null) {
                                this.setState({
                                    roomType: res.data
                                }, () => {
                                    ...
                                    axios.put('http://nativehotel2.herokuapp.com/api/room_types/'+room.idLP, room).then(res => {
                                        if (res.data != null) {
                                            var customer = {
                                            ...
                                            axios.post('http://nativehotel2.herokuapp.com/api/customer', customer).then(res => {
                                                if (res.data != null) {
                                                    ...
                                                    console.log(booking);
                                                    axios.post('http://nativehotel2.herokuapp.com/api/bookings', booking).then(res => {
                                                        if (res.data != null) {
                                                            ...
                                                            axios.post('http://nativehotel2.herokuapp.com/api/send_mail', data_obj).then(res => {
                                                                if (res.data == true) {
                                                                    this.notify();
