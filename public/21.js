...
var Slide = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Slide, [{
    ...
    value: function submitSlide(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('http://nativehotel2.herokuapp.com/api/slides_upload_file', fd, {
        headers: {
        ...
        _this2.setState({
          ...
          console.log(slide);
          axios__WEBPACK_IMPORTED_MODULE_9___default.a.post('http://nativehotel2.herokuapp.com/api/slides', slide).then(function (res) {
            if (res.data != null) {
