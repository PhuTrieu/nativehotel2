...
var SlideForm = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SlideForm, [{
    ...
    value: function findSlideByID(idSlide) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_6___default.a.get('http://nativehotel2.herokuapp.com/api/slides/' + idSlide).then(function (res) {
        if (res.data != null) {
          _this2.setState({
    ...
    value: function saveChange(e) {
      ...
      if (this.state.hinhAnh !== this.state.hinhAnhCu) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_6___default.a.post('http://nativehotel2.herokuapp.com/api/slides_delete_file', data).then(function (res) {
          if (res.data) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_6___default.a.post('http://nativehotel2.herokuapp.com/api/slides_upload_file', fd, {
          headers: {
          ...
          _this3.setState({
            ...
            if (window.confirm('Are you sure ?')) {
              console.log(slide);
              axios__WEBPACK_IMPORTED_MODULE_6___default.a.put('http://nativehotel2.herokuapp.com/api/slides/' + slide.idSlide, slide).then(function (res) {
                if (res.data != null) {
                  setTimeout(function () {
