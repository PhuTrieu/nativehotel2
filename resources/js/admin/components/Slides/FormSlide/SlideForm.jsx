...
export default class SlideForm extends Component {
    ...
    findSlideByID(idSlide){
        axios.get('http://nativehotel2.herokuapp.com/api/slides/' + idSlide).then(res => {
            if (res.data != null) {
                this.setState({
    ...
    saveChange(e){
        if (this.state.hinhAnh !== this.state.hinhAnhCu) {
            ...
            axios.post('http://nativehotel2.herokuapp.com/api/slides_upload_file', fd, {
                headers: {
            ...
            .then(res=>{
                ...
                this.setState({
                    ...
                    if (window.confirm('Are you sure ?')) {
                        console.log(slide);
                        axios.put('http://nativehotel2.herokuapp.com/api/slides/'+slide.idSlide, slide).then(res => {
                            if (res.data != null) {
