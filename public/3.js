...
var Slide = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Slide, [{
    ...
    value: function loadSlides() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get('http://nativehotel2.herokuapp.com/api/slides').then(function (response) {
        _this2.setState({
          slide: response.data
        });
      });
    ...
    value: function deleteSlide(obj) {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('http://nativehotel2.herokuapp.com/api/slides_delete_file', data).then(function (res) {
          if (res.data) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_4___default.a["delete"]('http://nativehotel2.herokuapp.com/api/slides/' + obj.id).then(function (res) {
          if (res.data != null) {
            _this3.loadSlides();
          }
    ...
    value: function render() {
      ...
      }, "Th\xEAm slide qu\u1EA3ng c\xE1o"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", {
        className: "text-center mt-2"
      }, "DANH S\xC1CH SLIDE QU\u1EA2NG C\xC1O"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_1__["Table"], {
        striped: true
