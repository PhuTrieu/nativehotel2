...
var AdminAccounts = /*#__PURE__*/function (_Component) {
  ...
  _createClass(AdminAccounts, [{
    ...
    value: function loadAdminAccounts() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get('http://nativehotel2.herokuapp.com/api/admin_accounts').then(function (response) {
        _this2.setState({
    ...
    value: function deleteAdminAccount(id) {
      ...
      if (window.confirm('Are you sure?')) {
        axios__WEBPACK_IMPORTED_MODULE_4___default.a["delete"]('http://nativehotel2.herokuapp.com/api/admin_accounts/' + id).then(function (res) {
          if (res.data != null) {
