...
var Rates = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Rates, [{
    ...
    value: function loadRates() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://nativehotel2.herokuapp.com/api/rates').then(function (response) {
        _this2.setState({
          rates: response.data
        });
      });
    ...
    value: function deleteRates(id) {
      ...
      if (window.confirm('Are you sure?')) {
        axios__WEBPACK_IMPORTED_MODULE_3___default.a["delete"]('http://nativehotel2.herokuapp.com/api/rates/' + id).then(function (response) {
