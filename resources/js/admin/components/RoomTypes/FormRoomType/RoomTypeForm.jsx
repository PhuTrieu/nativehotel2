...
export default class RoomTypeForm extends Component {
    ...
    findRoomTypeByID(id){
        axios.get('http://nativehotel2.herokuapp.com/api/room_types/' + id).then(res => {
            if (res.data != null) {
                this.setState({
                    idLP: res.data.idLP,
    ...
    saveChange(e){
        ...
        if(this.state.hinhAnh === this.state.imgRaw){
            ...
            axios.post('http://nativehotel2.herokuapp.com/api/room_types_delete_file',data).then(res=>{
                if(res.data)
            ...
            axios.post('http://nativehotel2.herokuapp.com/api/room_types_upload_file', fd, {
                headers: {
