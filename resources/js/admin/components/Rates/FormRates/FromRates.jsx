...
export default class FromRates extends Component {
    ...
    findRatesByID(id){
        axios.get('http://nativehotel2.herokuapp.com/api/rates/'+id).then( response => {
            if(response!=null){
                this.setState({
    ...
    saveChange(){
        ...
        if(window.confirm('Are you sure?')){
            console.log(rates);
            axios.put('http://nativehotel2.herokuapp.com/api/rates/'+rates.idBG,rates).then(response => {
                if(response.data!=null){
