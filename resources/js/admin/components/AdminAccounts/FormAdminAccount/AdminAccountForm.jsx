...
export default class AdminAccountForm extends Component {
    ...
    findAdminAccountByID(idAdminAcc){
        axios.get('http://nativehotel2.herokuapp.com/api/admin_accounts/' + idAdminAcc).then(res => {
            if (res.data != null) {
                this.setState({
    ...
    saveChange(e){
        ...
        if (window.confirm('Are you sure ?')) {
            ...
            axios.put('http://nativehotel2.herokuapp.com/api/admin_accounts/'+AdminAccount.idAdmin, AdminAccount).then(res => {
                if (res.data != null) {
