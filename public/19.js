...
var RoomTypeForm = /*#__PURE__*/function (_Component) {
  ...
  _createClass(RoomTypeForm, [{
    ...
    value: function findRoomTypeByID(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('http://nativehotel2.herokuapp.com/api/room_types/' + id).then(function (res) {
        if (res.data != null) {
          _this2.setState({
            idLP: res.data.idLP,
    ...
    value: function saveChange(e) {
      ...
      if (this.state.hinhAnh === this.state.imgRaw) {
        this.setState({
          ...
          if (window.confirm('Are you sure ?')) {
            axios__WEBPACK_IMPORTED_MODULE_5___default.a.put('http://nativehotel2.herokuapp.com/api/room_types/' + roomType.idLP, roomType).then(function (res) {
              if (res.data != null) {
                setTimeout(function () {
        ...
        axios__WEBPACK_IMPORTED_MODULE_5___default.a.post('http://nativehotel2.herokuapp.com/api/room_types_delete_file', data).then(function (res) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_5___default.a.post('http://nativehotel2.herokuapp.com/api/room_types_upload_file', fd, {
          headers: {
      ...
      //     console.log('value room: ',roomType);
      //     if (window.confirm('Are you sure ?')) {
      //         axios.put('http://nativehotel2.herokuapp.com/api/room_types/'+roomType.idLP, roomType).then(res => {
      //             if (res.data != null) {
