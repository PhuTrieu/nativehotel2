...
var FromCustomer = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FromCustomer, [{
    ...
    value: function findCustomerByID(idCustomer) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get('http://nativehotel2.herokuapp.com/api/customer/' + idCustomer).then(function (response) {
        if (response != null) {
          _this2.setState({
    ...
    value: function saveChange() {
      ...
      if (window.confirm('Are you sure?')) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.put('http://nativehotel2.herokuapp.com/api/customer/' + customer.idKH, customer).then(function (response) {
